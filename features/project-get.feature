Feature:
  ...
  As a Project Manager i want to see full information of projects where i'm assigned
  ...
  Scenario: As a Project Manager i want to see full information of projects where i'm assigned
